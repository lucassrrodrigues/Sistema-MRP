...
$sql = "SELECT data_venda, SUM(total_venda) AS total_vendido FROM vendas WHERE id_usuario = $id_usuario $filtros_sql GROUP BY data_venda";
...
<head>
    ...
    <title>UpperPro - Histograma de Vendas</title>
    <link rel="icon" href="../img/logo.png" type="image/png">
</head>

<body>
    <div class="container mt-4">
        <h1>Histograma de Vendas</h1>
        <canvas id="histogramaVendas"></canvas>
        <a href="relatorio_vendas.php" class="btn btn-primary mt-3">Voltar</a>
    </div>

    <script>
        var ctx = document.getElementById('histogramaVendas').getContext('2d');
        var histogramaVendas = new Chart(ctx, {
            type: 'bar',
            data: {
