...
<body>
        ...
        <div class="form-container">
            ...
            <form action="fazer_login.php" method="post">
                ...
                <div class="link-cadastro">
                    <a href="../Cadastro/cadastro.php">Ainda não tem cadastro? Inscreva-se agora!</a>
                </div>
    ...
    <?php
        ...
        if(isset($_GET['erro']) && $_GET['erro'] == 1) {
            echo '<div class="error-banner" role="alert">E-mail ou senha inválidos.</div>';
        }
        ?>
</body>
